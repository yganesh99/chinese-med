...
│   └── Sections.tsx        # Services, Philosophy, Research, Contact, Footer
...
-   Article cards with citations
-   Links to full study publications
...
-   Research: `components/Sections.tsx` - `articles` array
