        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="slide-up text-white">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              Ancient Wisdom for
              <br />
              <span className="font-serif block mt-2">Modern Wellness</span>
            </h1>
            
            <p className="text-xl md:text-2xl mb-8 leading-relaxed text-white/90 max-w-xl">
              Experience the profound healing power of Traditional Chinese Medicine. 
              We combine time-honored practices with modern understanding to restore 
          ...
          <div className="relative fade-in">
            ...
            <div className="absolute -bottom-6 -left-6 w-36 h-36 bg-secondary rounded-full layer-shadow opacity-80 animate-pulse" style={{ animationDelay: '0.5s' }}></div>
          </div>
        </div>
      </div>
