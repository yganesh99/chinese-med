  ...
  const services = [
    {
      title: 'Acupuncture',
      chinese: '针灸',
      description: 'Ancient needle therapy that stimulates specific points on the body to restore energy flow, alleviate pain, and promote natural healing. Effective for chronic pain, stress, and various health conditions.',
      image: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=500&h=400&fit=crop',
      benefits: ['Pain Relief', 'Stress Reduction', 'Improved Sleep', 'Enhanced Immunity']
    },
    {
      title: 'Herbal Medicine',
      chinese: '中药',
      description: 'Carefully formulated herbal remedies using premium organic ingredients. Each prescription is customized to your unique constitution and health needs.',
      image: 'https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?w=500&h=400&fit=crop',
      benefits: ['Natural Healing', 'Holistic Balance', 'Customized Care', 'Long-term Wellness']
    },
    {
      title: 'Tui Na Massage',
      chinese: '推拿',
      description: 'Therapeutic Chinese massage combining acupressure, manipulation, and stretching to improve circulation, release tension, and harmonize energy pathways.',
      image: 'https://images.unsplash.com/photo-1600334129128-685c5582fd35?w=500&h=400&fit=crop',
      benefits: ['Muscle Relaxation', 'Improved Circulation', 'Energy Balance', 'Flexibility']
    },
    {
      title: 'Dietary Therapy',
      chinese: '食疗',
      description: 'Personalized nutritional guidance based on TCM principles. Learn how to nourish your body with foods that support your constitution and promote vitality.',
      image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=500&h=400&fit=crop',
      benefits: ['Digestive Health', 'Energy Boost', 'Disease Prevention', 'Optimal Nutrition']
    }
  ];

  return (
    <section id="services" className="py-24 bg-gradient-to-b from-background to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div 
          ref={ref1} 
          className={`text-center mb-16 scroll-reveal ${isVisible1 ? 'revealed' : ''}`}
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-foreground mb-6">
            Comprehensive <span className="gradient-text">TCM Treatments</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Traditional Chinese Medicine treatments tailored to your unique needs
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              ref={ref2}
              className={`group bg-white layer-shadow rounded-3xl overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl scroll-reveal ${isVisible2 ? 'revealed' : ''}`}
  ...
  const principles = [
    {
      ...
      description: 'Restoring the natural equilibrium of Yin and Yang, allowing your body to heal itself through balanced energy flow.'
    },
    {
      icon: '🌿',
      title: 'Natural Healing',
      description: 'Harnessing the power of nature using organic herbs, gentle techniques, and time-tested wisdom passed through generations.'
    },
    {
      icon: '👤',
      title: 'Holistic Approach',
      description: 'Treating the whole person - body, mind, and spirit - addressing root causes rather than just symptoms.'
    },
    {
      icon: '🎯',
      title: 'Personalized Care',
      description: 'Creating customized treatment plans based on your specific constitution, lifestyle, and health goals.'
    }
  ];

  return (
    <section id="philosophy" className="py-24 bg-gradient-to-b from-white to-primary/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div 
            ref={ref} 
            className={`scroll-reveal ${isVisible ? 'revealed' : ''} order-2 lg:order-1`}
          >
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-5xl md:text-6xl font-bold text-foreground mb-6">
              Ancient Wisdom, <span className="gradient-text">Modern Care</span>
            </h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Traditional Chinese Medicine is built on the foundation of balance, harmony, 
              and interconnection. With over 2,500 years of wisdom, we provide holistic care 
              that addresses not just symptoms, but the root cause of imbalance.
            </p>
            ...
            <div className="space-y-6">
              {principles.map((principle, index) => (
                <div
                  key={index}
                  className="bg-white layer-shadow p-6 rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                >
...
export function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 bg-gradient-to-b from-primary/5 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div 
          ref={ref} 
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Real experiences from real people who found healing and wellness
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white/95 backdrop-blur-sm layer-shadow-lg rounded-3xl p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
            >
...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-b from-white to-primary/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-xl text-gray-700 mb-12 leading-relaxed">
              Take the first step towards balanced health and vitality. 
              Schedule a consultation to discover how Traditional Chinese Medicine 
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Wellness Street<br />Melbourne, VIC 3000</p>
                </div>
              </div>
          ...
          <div className="bg-white layer-shadow-lg rounded-3xl p-8 md:p-10">
    ...
    <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="text-3xl font-serif font-bold text-primary">自然</div>
              <div className="text-lg font-semibold">TCM Clinic</div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Providing high-quality, local, organic supplements, vitamins and homeopathic 
              remedies to empower health and wellbeing.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-11 h-11 bg-primary rounded-full flex items-center justify-center hover:bg-primary-dark transition-colors hover:-translate-y-1 duration-300">
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
          <p>&copy; 2025 自然 TCM Clinic. All rights reserved. | Privacy Policy | Terms of Service</p>
        </div>
      </div>
    </footer>
  );
